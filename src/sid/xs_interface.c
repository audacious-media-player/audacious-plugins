...
create_xs_configwin (void)
{
  ...
  cfg_samplerate_combo_items = g_list_append (cfg_samplerate_combo_items, (gpointer) _("8000"));
  cfg_samplerate_combo_items = g_list_append (cfg_samplerate_combo_items, (gpointer) _("11025"));
  cfg_samplerate_combo_items = g_list_append (cfg_samplerate_combo_items, (gpointer) _("22050"));
  cfg_samplerate_combo_items = g_list_append (cfg_samplerate_combo_items, (gpointer) _("44100"));
  cfg_samplerate_combo_items = g_list_append (cfg_samplerate_combo_items, (gpointer) _("48000"));
  cfg_samplerate_combo_items = g_list_append (cfg_samplerate_combo_items, (gpointer) _("64000"));
  cfg_samplerate_combo_items = g_list_append (cfg_samplerate_combo_items, (gpointer) _("96000"));
