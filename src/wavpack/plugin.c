...
Tuple *wv_get_song_tuple(gchar *filename);
gint wv_is_our_fd(gchar *filename, VFSFile *file);
Tuple *wv_probe_for_tuple(gchar *filename, VFSFile *file);
