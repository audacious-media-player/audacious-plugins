...
#define YYTRANSLATE(x) ((unsigned)(x) <= 259 ? yytranslate[x] : 22)
...
static const short yyprhs[] = {     0,
     0,     1,     4,     5,     7,    10,    13,    15,    19,    21,
    23,    27,    32,    36,    40,    44,    48,    52,    56,    59,
    63
};

static const short yyrhs[] = {    -1,
    18,    19,     0,     0,    21,     0,    19,    12,     0,     1,
    12,     0,    21,     0,    20,    13,    21,     0,     4,     0,
     3,     0,     3,     5,    21,     0,     3,    14,    20,    15,
     0,    21,    16,    21,     0,    21,    17,    21,     0,    21,
     7,    21,     0,    21,     6,    21,     0,    21,     8,    21,
     0,    21,     9,    21,     0,     6,    21,     0,    21,    11,
    21,     0,    14,    21,    15,     0
};
...
static const short yyrline[] = { 0,
    73,    74,    78,    79,    81,    82,    86,    90,    95,   101,
   107,   113,   120,   122,   125,   127,   129,   131,   133,   135,
   137
};
#endif
...
"'='","'-'","'+'","'*'","'/'","NEG","'^'","';'","','","'('","')'","'>'","'<'",
"input","expression_list","argument_list","expression", NULL
};
#endif
...
static const short yydefact[] = {     1,
     0,     0,    10,     9,     0,     0,     2,     4,     6,     0,
     0,    19,     0,     5,     0,     0,     0,     0,     0,     0,
     0,    11,     0,     7,    21,    16,    15,    17,    18,    20,
    13,    14,     0,    12,     8,     0,     0
};
...
static const short yypact[] = {-32768,
    17,    -8,    22,-32768,    47,    47,    -3,    38,-32768,    47,
    47,    -9,    26,-32768,    47,    47,    47,    47,    47,    47,
    47,    38,     9,    38,-32768,    48,    48,    -9,    -9,    -9,
    38,    38,    47,-32768,    38,     3,-32768
};
...
static const short yytable[] = {    12,
    13,    19,    37,     9,    22,    24,    20,    21,    14,    26,
    27,    28,    29,    30,    31,    32,    36,     2,     0,     3,
     4,    33,     5,    34,     0,     0,    10,    35,    -3,     0,
     6,    15,    16,    17,    18,    11,    19,     0,     0,     0,
    25,    20,    21,    15,    16,    17,    18,     0,    19,     3,
     4,     0,     5,    20,    21,    17,    18,     0,    19,     0,
     6,     0,     0,    20,    21
};

static const short yycheck[] = {     5,
     6,    11,     0,    12,    10,    11,    16,    17,    12,    15,
    16,    17,    18,    19,    20,    21,     0,     1,    -1,     3,
     4,    13,     6,    15,    -1,    -1,     5,    33,    12,    -1,
    14,     6,     7,     8,     9,    14,    11,    -1,    -1,    -1,
    15,    16,    17,     6,     7,     8,     9,    -1,    11,     3,
     4,    -1,     6,    16,    17,     8,     9,    -1,    11,    -1,
    14,    -1,    -1,    16,    17
};
#define YYPURE 1
